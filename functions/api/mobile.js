/**
 * GET /api/mobile?url=https://example.com
 */

import { analyzeMobile } from "../../src/tools/mobile/index.js";
import {
  success,
  error,
  corsPreflight,
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await analyzeMobile(target);
    ...
    return error(
      "INTERNAL_ERROR",
      "An unexpected error occurred while analyzing mobile friendliness.",
      500,
      { request, requestId }
    );
  }
