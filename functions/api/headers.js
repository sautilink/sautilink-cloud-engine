 ...
 * Safe HTTP response headers analysis with SSRF protections.
 */

import { analyzeHttpHeaders } from "../../src/tools/headers/index.js";
import {
  success,
  error,
  corsPreflight,
...
export async function onRequest(context) {
  ...
  try {
    ...
    const data = await analyzeHttpHeaders(target);
    ...
    return error(
      "INTERNAL_ERROR",
      "An unexpected error occurred while analyzing headers.",
      500,
      { request, requestId }
    );
  }
