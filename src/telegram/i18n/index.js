...
export function resolveLocale({chatId,languageCode}={}){prune();if(chatId!=null){const p=preferences.get(String(chatId));if(p&&p.expiresAt>Date.now())return p.locale;}return normalizeLocale(languageCode||DEFAULT_LOCALE);}
